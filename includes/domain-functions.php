 ...
 */
function get_domain_alternatives($post_id, $limit = 3) {
    if (!get_option('domain_show_alternatives', true) || !$post_id) {
        return [];
    }
    ...
    $args = [
        'post_type' => 'domain',
        'posts_per_page' => $limit + 2, // Get extra in case some are filtered out
        'post_status' => 'publish',
 ...
 * @param bool $show_currency Whether to show currency symbol
 ...
 * @param array $tld_rules TLD-specific rules
...
/**
 * Convert TLD to URL slug
 * 
 * @param string $tld TLD string
...
/**
 * Convert URL slug back to TLD
 * 
 * @param string $slug URL slug
 * @return string TLD string
 */
